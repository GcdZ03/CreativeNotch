...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-394-brightgreen" alt="394 tests">
...
```bash
swift test           # 394 tests, ~1s, no window server needed
...
Tests/
  CreativeNotchCoreTests/   169 tests
  CreativeNotchUITests/     225 tests
```
